...
class AgentWithGoal(object):
    def __init__(self, action_set, slot_set, disease_symptom, parameter):
        ...
        # Intrinsic critic: binary classifier to determine the sub-task whether terminate.
        # Maybe heuristic or model based (maximal likelihood).
    ...
    def intrinsic_critic(self, state, agent_action, goal):
        ...
        if goal != 0: # symptom inquiring sub-task
            ...
            terminate = True
            intrinsic_reward = 1
        return terminate, intrinsic_reward
